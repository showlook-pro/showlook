const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://xiaolu.love',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://xiaolu.love',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'ShowlookFans',
  LANDING_HERO_P_1: '快速搭建独立站、轻松放大品牌价值！',
  LANDING_HERO_BUTTON_1_TEXT: '开始体验',
  LANDING_HERO_BUTTON_1_LINK: 'https://xiaolu.love',
  LANDING_HERO_BUTTON_2_TEXT: '了解更多',
  LANDING_HERO_BUTTON_2_LINK: 'https://xiaolu.love',
  ...
  LANDING_FEATURES_BLOCK_6_P: 'ShowlookFans，助您轻松开始写作',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://xiaolu.love',// 重定向网站地址

  LANDING_PRICING_TITLE: '价格表',
  LANDING_PRICING_P: 'ShowlookFans开源免费，此处仅演示订阅付费功能！请勿购买！',
  ...
  LANDING_PRICING_1_URL: 'https://xiaolu.love',
  ...
  LANDING_PRICING_2_URL: 'https://xiaolu.love',
  ...
  LANDING_PRICING_3_URL: 'https://xiaolu.love',

  LANDING_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_LANDING_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://xiaolu.love
}
